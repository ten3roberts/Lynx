...
bool Lynx::Input::getKeyHit(int keycode) 
{
    return m_keys[keycode] && !m_prevKeys[keycode];
}

bool Lynx::Input::getKeyDown(int keycode) 
{
    return m_keys[keycode];
}

bool Lynx::Input::getKeyReleased(int keycode) 
{
   return !m_keys[keycode] && m_prevKeys[keycode];
}
...
void Lynx::Input::Update() 
{
    memcpy(m_prevKeys, m_keys, sizeof(bool) * KEY_LAST);
}
