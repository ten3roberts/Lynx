// From glfw3.h to avoid including glfw3 in client application

// Unknown key
#define KEY_UNKNOWN -1

// The first keys are mouse buttons
...
// Shorthand for the mouse button keys
#define MB_1 0
#define MB_2 1
#define MB_3 2
#define MB_4 3
...
#define MB_7 6
#define MB_8 7
#define MB_LAST GLFW_MOUSE_BUTTON_8
